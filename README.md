...
## Environments
- Preview: https://main--we-finance--Surabhi-helium.hlx.page/
- Live: https://main--we-finance--Surabhi-helium.hlx.live/
...
1. Open the `we-finance` directory in your favorite IDE and start coding :)
